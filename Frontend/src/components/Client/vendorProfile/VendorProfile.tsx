...
interface VendorDetailsProps {
    vendor: VendorProfileEntityInClient
}

const vendor: VendorProfileEntityInClient = {
    _id: "65d1c4e9e9f7b2b4a7b9c0a1",
    title: "Sample Vendor",
    description: "This is a sample vendor description.",
    images: ["/placeholder.svg?height=600&width=600", "/placeholder.svg?height=600&width=600"],
    vendorId: {
        _id: "65d1c4e9e9f7b2b4a7b9c0a2",
        profileImage: "/placeholder.svg?height=100&width=100",
        aboutVendor: "This is a sample vendor bio.",
    },
}
...
export default function VendorDetails() {
    ...
    return (
        <motion.div
            className="bg-black w-full pt-10 pb-10 text-white rounded-xl overflow-hidden shadow-2xl  mx-auto"
            initial="hidden"
            animate="visible"
