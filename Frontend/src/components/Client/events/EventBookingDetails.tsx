            ...
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
                    ...
                    <motion.div variants={fadeIn} className="lg:col-span-2 z-10">
                        {/* <iframe
                            src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3907.5468551542047!2d${event?.location?.latitude}!3d${event?.location?.longitude}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTHCsDQwJzI0LjAiTiA3NsKwMTUnMjQuMCJF!5e0!3m2!1sen!2sin!4v1650956938000!5m2!1sen!2sin`}
                            width="100%"
                            height="300"
                            style={{ border: 0 }}
                            allowFullScreen
