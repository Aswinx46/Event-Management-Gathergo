...
import { Clock, IndianRupee, Award, Info, FileText } from 'lucide-react';
...
interface ServiceCardProps {
  ...
  handleServiceBooking: (serviceId: string, vendorId: string) => void
}
    ...
    >
      <div className="relative flex-1 flex flex-col">
        ...
        <div className="p-6 bg-gray-900 flex-1">
          ...
          >
            <IndianRupee size={18} className="mr-3 text-gray-300 flex-shrink-0" />
            <div>
        ...
        >
          <button
            onClick={() => handleServiceBooking(serviceId,vendorId)}
