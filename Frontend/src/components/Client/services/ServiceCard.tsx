...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <motion.div
      className="bg-black rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-800"
    ...
    >
      <div className="relative">
        ...
        <div className="p-6 border-b border-gray-800">
          ...
          >
            <Award size={16} className="mr-2 text-gray-300" />
        ...
        <div className="p-6 bg-gray-900">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">{cancellationPolicy}</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 line-clamp-3">{termsAndCondition}</p>
            </div>
          </motion.div>
        </div>
