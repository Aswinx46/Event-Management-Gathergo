...
import { injectedAdminLoginController, injectedApproveVendorStatus, injectedFindAllPendingVendorController, injectedFindAllVendorController, injectedRejectVendorController } from "../../Di/adminInject";
